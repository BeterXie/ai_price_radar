...
const items = [
  ...
  ["提交方式", "请使用仓库所有者 GitHub 资料页关联的邮箱私下报告，附上受影响版本、复现步骤、影响范围和建议修复。不要在公开 Issue 中发布可直接利用的细节。"],
  ["数据源边界", "商家 Feed 只接受 HTTPS 公网地址，并拒绝本地、私网和保留 IP；导入器限制响应体积并按统一数据模型校验。"],
 ] as const;

export default function SecurityPage() {
  return <InfoPage eyebrow="项目安全" title="安全与负责任披露" description="请通过私密渠道提交可复现的安全问题，并尽量减少测试影响。"><FactLedger items={items} /></InfoPage>;
}
