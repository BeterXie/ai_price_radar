...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "提交公开店铺链接，经过审核和抓取验证后加入报价目录。",
    url: "/shops/submit",
  },
};
    ...
    <main id="main-content" className="shell py-12 md:py-16">
      <section className="grid gap-10 lg:grid-cols-[.85fr_1.15fr] lg:gap-16">
        <div className="lg:pt-4">
          ...
          <p className="mt-6 max-w-xl text-base leading-7 text-[color:var(--muted)]">商家可以提交公开店铺链接。我们会核验店铺可访问性、商品范围和报价信息，再决定是否收录。</p>

          <div className="mt-10 max-w-xl border-t border-black">
            {[
              { Icon: Eye, title: "核验公开页面", copy: "确认店铺无需登录即可访问，并能稳定读取公开商品。" },
          ...
          <p className="mt-6 max-w-xl text-xs leading-5 text-black/45">提交申请不代表自动收录。非公开店铺、不含目标商品或无法稳定核验的店铺不会进入公开目录。</p>
        </div>
