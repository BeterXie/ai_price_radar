...
export const metadata: Metadata = { title: "关于本站", description: "了解 AI Price Memory (AI Price Radar) 如何整理公开 AI 商品报价。", alternates: { canonical: "/about" } };
