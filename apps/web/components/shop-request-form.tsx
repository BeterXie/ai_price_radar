...
export function ShopRequestForm() {
  ...
  return <form onSubmit={submit} className="rounded-[18px] border hairline bg-[color:var(--panel)] p-5 sm:p-7">
    ...
    <div className="mt-5 grid gap-5">
      ...
      <label className="grid gap-2 text-sm font-medium" htmlFor="shop-contact">联系方式 <span className="font-normal text-black/45">选填</span><input id="shop-contact" maxLength={200} value={contact} onChange={(e)=>setContact(e.target.value)} placeholder="邮箱、微信或其他可联系账号" className="rounded-[10px] border hairline bg-white px-3 py-3 text-sm outline-none focus:border-black"/></label>
