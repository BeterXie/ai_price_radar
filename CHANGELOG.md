...
### Changed
- **优惠券强制绑定真实店铺与无默认店铺回退**:
  - 去除 `ShopCoupon` 模型及导入 Schema 中对“彩头AI / wzyp.cn”等默认店铺名称与链接的硬编码，默认均置空；
  - 管理后台导入券码时将「归属店铺」设为必选字段，杜绝静默导入到默认公共店铺池；
  - 个人中心优惠券列表新增专属「适用店铺」标头，清晰呈现所属商家；若未配置店铺外链则安全展示“店铺链接未配置”禁止跳转；
  - 彩蛋掉落浮窗增加平台中立声明（“优惠券由对应店铺提供，不影响 PriceMemo 的报价排序”），文案调整为“已保存”与“查看我的优惠券”。
